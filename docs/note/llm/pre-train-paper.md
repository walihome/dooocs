...
### GPT-1 (2018)
名称： [`Improving Language Understanding by Generative Pre-Trainin`](https://openai.com/search/?q=Improving+Language+Understanding+by+Generative+Pre)  
...
### GPT-2 (2019)
名称： [`Language Models are Unsupervised Multitask Learners `]()  
作者/机构： `Alec Radford et al. (OpenAI)`   
...
### GPT-3 (2020)
名称：[`Language Models are Few-Shot Learners `](https://arxiv.org/abs/2005.14165)  
...
### LLaMA (2023)
名称：[`Open and Efficient Foundation Language Models`](https://arxiv.org/abs/2302.13971)  
