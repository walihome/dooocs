...
export const java = [
    {
      ...
      items: [
        ...
        { text: '新手教程', collapsed: false, items: [
          { text: 'Java 基础操作', collapsed: true, items: [
            { text: 'hello_world', link: '/java/new/basic_operation/Java_Hello_World.html' },
            { text: 'Java JDK, JRE 和 JVM', link: '/java/new/basic_operation/Java_JVM_JRE_and_JDK.html' },
            { text: 'Java 变量', link: '/java/new/basic_operation/Java_variables_and_literals.html' },
            { text: 'Java 基本数据类型', link: '/java/new/basic_operation/Java_primitive_data_types.html' },
            { text: 'Java 基本操作类型', link: '/java/new/basic_operation/Java_operators.html' },
            { text: 'Java 输入输出', link: '/java/new/basic_operation/Java_input_and_output.html' },
            { text: 'Java 运算符', link: '/java/new/basic_operation/Java_Expressions_&_Statements.html' },
            { text: 'Java 注释', link: '/java/new/basic_operation/Java_comments.html' },
          ]},
        ...
        { text: '进阶教程', collapsed: true, items: [
          { text: '基础语法', link: '/java/basic_operation/basic_grammer.html' },
          { text: '基本数据类型', link: '/java/basic_operation/data_type.html' },
          { text: '基本运算', link: '/java/basic_operation/operate.html' },
          { text: '集合', link: '/java/basic_operation/collection.html' },
          { text: '控制流程', link: '/java/basic_operation/control_flow.html' },
          { text: '方法|函数', link: '/java/basic_operation/method.html' },
          { text: '枚举', link: '/java/basic_operation/enum.html' },
          { text: '接口和类', link: '/java/basic_operation/interface_and_class.html' },
          { text: '面向对象基础', link: '/java/basic_operation/oop.html' },
          { text: '继承和多态', link: '/java/basic_operation/inheritance_and_polymorphism.html' },
          { text: '泛型', link: '/java/basic_operation/generic.html' },
          { text: '异常', link: '/java/basic_operation/exception.html' },
          { text: '并发', link: '/java/basic_operation/concurrency.html' },
          { text: '反射', link: '/java/basic_operation/reflect.html' },
          { text: '注解', link: '/java/basic_operation/annotation.html' },
          { text: 'SPI', link: '/java/basic_operation/spi.html' },
          { text: '序列化', link: '/java/basic_operation/serializable.html' },
          { text: 'IO', link: '/java/basic_operation/io.html' },
          { text: '语法糖', link: '/java/basic_operation/syntactic_sugar.html' },
          { text: '参考', link: '/java/basic_operation/reference.html' },
...
export const swift = [
    {
      ...
      items: [
        ...
        { text: '基础知识',  collapsed: true, items: [
          { text: '基础语法', link: '/swift/basic_operation/basic_grammar.html' },
          { text: '基础运算符', link: '/swift/basic_operation/basic_operators.html' },
        ]},
      ]
    }
  ];
...
export const python = [
    {
      ...
      items: [
        ...
        { text: '基础知识',  collapsed: true, items: [
          { text: '基础语法', link: '/python/basic_operation/basic.html' },
